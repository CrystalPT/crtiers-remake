      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          ...
          <div className={styles.heroButtons}>
            <a href="/crtiers-remake/leaderboards" className="btn-primary">View Rankings</a>
            <a href="/crtiers-remake/server" className={styles.btnSecondary}>Join Server</a>
          </div>
        </section>
        ...
        <section className={styles.features}>
          <div className={styles.featureGrid}>
            ...
            <div className="card">
              ...
              <a href="/crtiers-remake/server" className={styles.featureLink}>Server Info →</a>
            </div>
            
            <div className="card">
              <h3>📊 Tier System</h3>
              <p>Advanced tier-based ranking from F to S+ with region-based categorization and detailed statistics.</p>
              <a href="/crtiers-remake/more" className={styles.featureLink}>Learn More →</a>
            </div>
          </div>
        </section>
